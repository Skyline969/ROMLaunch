...
#region Buttons
        ...
        private void btnLaunchROM_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("\" " + selectedEmuArgs + " " + selectedEmuROMPath + "\\" + selectedROM + "\"");
                    System.Diagnostics.Process.Start(selectedEmu, "\" " + selectedEmuArgs + " " + selectedEmuROMPath + "\\" + selectedROM + "\"");
                }
            }
            catch (Exception ex)
            {
